...
{
	public partial class ExampleWorkerThread
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget DockingExamples.ExampleWorkerThread
			global::Stetic.BinContainer.Attach (this);
			this.Name = "DockingExamples.ExampleWorkerThread";
			// Container child DockingExamples.ExampleWorkerThread.Gtk.Container+ContainerChild
			...
			this.label1.LabelProp = "Docking.Tools.WorkerThread";
			...
			this.buttonStartThread.Label = "Start";
			...
			this.label2.LabelProp = "System.Factory.Task";
			...
			this.buttonStartTask.Label = "Start";
			...
			this.labelTaskCount.LabelProp = "Count: 0";
			...
			this.label3.LabelProp = "Endless thread";
			...
			this.buttonEndlessStart.Label = "Start";
			...
			this.buttonEndlessStop.Label = "Stop";
